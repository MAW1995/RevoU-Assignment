...
function triangle_circumference() {
    ...
    // Display result in HTML element
    document.getElementById("result-of-triangle-circumference").textContent = result;
;
return false;
;
}
...
function reset(){
    // Reset
    document.getElementById("triangle_circumference").reset
}
...
function reset(){
    // Reset
    document.getElementById("parallelogram_area").reset();
}

function parallelogram_circumference() {
    ...
    // Display result in HTML element
    document.getElementById("result-of-parallelogram-circumference").textContent = result;
;
return false;
;
}
...
function reset(){
    // Reset
    document.getElementById("parallelogram_circumference").reset();
}